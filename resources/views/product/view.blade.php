                    ...
                    <div class="col-12">
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="card-header">
                                <a class="btn btn-outline-primary" href="{{ route('newproducts') }}">
                                    New Products
                                </a>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($products as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item->name }}</td>
                                                    <td><a class="text-primary">{{ $item->category }}</a></td>
                                                    <td><a class="text-primary">{{ $item->sub_category }}</a></td>
                                                    <td><a class="text-primary">{{ $item->com_price }}</a></td>
                                                    <td><a class="text-primary">{{ $item->dealer_price }}</a></td>
                                                    <td><a class="text-primary">{{ $item->price }}</a></td>
