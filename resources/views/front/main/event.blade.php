            ...
            <div class="col-xl-7 col-lg-7 col-md-7">
                <div class="section__title eventarea__section__title">
                    <div class="section__title__button">
                        <div class="default__small__button">Class List</div>
                    </div>
                ...
                <div class="social__wrapper">
                    <div class="single__event__wraper" data-aos="fade-up">
                        <div class="eventarea__img">
                            <img src="frontend/img/event/event__1.png" alt="event">
                        </div>
                        <div class="eventarea__content__wraper">
                            <div class="eventarea__list">
                                <ul>
                                    ...
                                    <li>
                                        <a href="instructor-details.html">Mirnsdo .H</a> - Mentor
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="single__event__wraper single__event__wraper__2" data-aos="fade-up">
                        ...
                        <div class="eventarea__img">
                            <img src="frontend/img/event/event__2.png" alt="event">
                        </div>
                    </div>
                    ...
                    <div class="single__event__wraper" data-aos="fade-up">
                        <div class="eventarea__img">
                            <img src="frontend/img/event/event__3.png" alt="event">
                        </div>
                        <div class="eventarea__content__wraper">
                            <div class="eventarea__list">
                                <ul>
                    ...
                    <div class="single__event__wraper single__event__wraper__2" data-aos="fade-up">
                        ...
                        <div class="eventarea__img">
                            <img src="frontend/img/event/event__4.png" alt="event">
                        </div>
                    </div>
